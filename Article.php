    ...
    <div class="mb-32   elative items-center justify-center p-20  md:w-10/12 bg-white border  border-gray-200 shadow-lg rounded-2xl">
      ...
      <div class="mb-12 flex flex-wrap justify-center">
        <div class="w-full shrink-0 grow-0 basis-auto px-3 md:w-10/12">
          <div class="relative mb-6 img-article overflow-hidden rounded-lg bg-cover bg-no-repeat shadow-lg dark:shadow-black/20"
            data-te-ripple-init data-te-ripple-color="light">
            <img src="/image/Article1.jpeg" class="w-full" />
            <a href="#!">
      ...
      <div class="flex items-center space-x-3 ml-28"> <!-- Div avec des icônes espacées -->
        <!-- Icône de "like" -->
