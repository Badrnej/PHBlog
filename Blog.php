...
<?php include 'navbar.php'; ?>
    <section class="px-52 py-20 justify-center items-center">
        <div class="flex gap-5 items-center text-gray-600 mt-5 hover:text-gray-900 cursor-pointer">
            ...
            <span class="text-2xl text-blue-600 font-bold">Articles</span> <!-- Titre "Articles" -->
        </div>




        <div class="grid items-center mr-32 justify-center w-full   gap-40 max-w-7xl mt-10   grid-cols-1  mx-auto lg:grid-cols-3">
            ...
            <div class="relative  justify-center w-96 px-8 py-4 bg-white border  border-gray-200 shadow-lg rounded-2xl "> <!-- Bordure grise, ombre, coins arrondis, texte centré -->
             ...
             <div class="mt-6">
                 <a href="#" class="inline-flex items-center font-semibold text-blue-600 hover:text-neutral-600">Read More »</a>
             </div>
