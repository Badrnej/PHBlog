...
<footer>
    <div class="bg-[#175CE1]  mt-20 text-white">
              ...
              <svg version="1.1" viewBox="0 0 3368 512" xmlns="http://www.w3.org/2000/svg">
                <g fill="none" fill-rule="evenodd">
                  <g transform="translate(0 -75)">
                    ...
                    <text fill="white" font-family="Nunito-Bold, Nunito" font-size="510" font-weight="bold">
                      <tspan x="654" y="518">Getion de blog</tspan>
                    </text>
                  </g>
                </g>
              </svg>
      ...
      <div class="bg-blue-700 p-2 iteams-centre text-white">
        <div class="container mx-auto px-40  ">
          <div class="-mx-4 flex flex-wrap  justify-center ">
            ...
            <div class="px-4 w-full text-center sm:w-auto sm:text-left">
              Made with ❤️ by Hanane && Ferdaous && Badreddine .
            </div>
          </div>
        </div>
      </div>
